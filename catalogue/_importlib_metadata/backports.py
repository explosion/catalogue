"""
Source: https://github.com/jaraco/backports.entry_points_selectable
...
# This was modified to ensure that the SelectableGroups dict interface works with every version of importlib_metadata.
entry_points = entry_points_compat
